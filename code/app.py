...
st.title("🛠 Vibration Analysis System")
...
st.markdown("### UNPROCEESED CURRENT DATA")
...
st.markdown("### 🧪 PROCESSED NO_FAULT SIGNAL")
st.dataframe(no_fault_processed)
st.markdown("### 🧪 PROCESSED CURRENT SIGNAL")
st.dataframe(current_processed)
